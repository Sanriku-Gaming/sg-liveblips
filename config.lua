print('^5Live Blips^7 - Easily configurable live job blip system by Nicky of ^4SG Scripts^7')
Config = Config or {}

Config.Debug = false                -- true to enable prints with helpful data in both client and server

Config.UpdateFreq = 5               -- How often (in seconds) the loop runs to update jobs if necessary (loop every 2 seconds to check for any job/duty changes). higher pop servers may need to increase.
...
-- @param changeBlipText  - boolean (true/false) - set to true to change the blip text based on On/Off Duty
